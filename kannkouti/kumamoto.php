...
<script language="JavaScript">
    function setBG(n)
    {
        var img_src = "img/kumamoto/amakusagobasi.jpg"
        var img_name = "天草五橋";
    ...
    function setCG(n)
    {
        var img_src = "img/kumamoto/daikann.jpg"
        var img_name = "大観峰";
    ...
    function setDG(n)
    {
        var img_src = "img/kumamoto/simodaonnsenn.jpg"
        var img_name = "下田温泉";
...
<ul class="spot-list">
    <li>
        ...
        <img src="img/kumamoto/amakusagobasi.jpg" class="change" onclick="setBG()" width="150" height="217" alt="">
        <img src="img/kumamoto/daikann.jpg" class="change2" onclick="setCG(2)" width="150" height="217" alt="">
        <img src="img/kumamoto/simodaonnsenn.jpg" class="change3" onclick="setDG(3)" width="150" height="217" alt="">
    </li>
</ul>
<div class="picture1">
    <img id="image_change" src="img/kumamoto/amakusagobasi.jpg" width="1860" height="900">
</div>
<script type="text/javascript">
    img = new Array("img/kumamoto/amakusagobasi.jpg","img/kumamoto/daikann.jpg","img/kumamoto/simodaonnsenn.jpg"); //*(1)
    count = -1; //*(2)
    imgTimer();
