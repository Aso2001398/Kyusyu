...
<script language="JavaScript">
    function setBG(n)
    {
        var img_src = "../syop/img/nagasaki/iwadozinnja.jpeg"
        var img_name = "岩戸神社";
    ...
    function setCG(n)
    {
        var img_src = "../syop/img/nagasaki/misozienn.jpeg"
        var img_name = "三十路苑";
    ...
    function setDG(n)
    {
        var img_src = "../syop/img/nagasaki/oiranndamura.jpeg"
        var img_name = "オランダ村";
...
<div class="picture1">
    <img id="image_change" src="../syop/img/nagasaki/iwadozinnja.jpeg" width="1500" height="1200">
</div>
<script type="text/javascript">
    img = new Array("../syop/img/nagasaki/iwadozinnja.jpeg","../syop/img/nagasaki/misozienn.jpeg","../syop/img/nagasaki/oiranndamura.jpeg"); //*(1)
    count = -1; //*(2)
    imgTimer();
...
<a href="syouhinn_nagasaki.php" class="omiyage">＞お土産</a>
</h1>
</body>
</html>
