...
<ul class="spot-list">
    <li>
        ...
        <img src="img/nagasaki/iwadozinnja.jpeg" class="change" onclick="setBG()" width="150" height="217" alt="">
        <img src="img/nagasaki/misozienn.jpeg" class="change2" onclick="setCG(2)" width="150" height="217" alt="">
        <img src="img/nagasaki/oiranndamura.jpeg" class="change3" onclick="setDG(3)" width="150" height="217" alt="">
    </li>
</ul>
<div class="picture1">
    <img id="image_change" src="img/nagasaki/iwadozinnja.jpeg" width="1700" height="900">
</div>
...
<h1>
    <a href="syouhinn3.php" class="omiyage">＞お土産</a>
</h1>
</body>
</html>
